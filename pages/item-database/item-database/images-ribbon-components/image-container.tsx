...
import {setItemImages} from "../../../../store/item-database/item-database-slice";
    ...
    return (
        <div
            onDragLeave={(e) => {dragLeaveHandler(e)}}
              ...
              className={`${styles["image-drop-box"]} ${image? styles.imageContainer : ""}`}
        >
            <img src={image} alt={"Image " + imageTag}></img>
        </div>
    )
}
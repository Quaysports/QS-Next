...
function TitleRow() {
  return (
    <div className={`${styles["shipping-item-row"]} ${styles["title-row"]}`}>
      <div>Qty Per Box</div>
      <div>No. of Boxes</div>
      <div>Length</div>
      <div>Height</div>
...
function ItemRow({
  ...
  return (
    <>
      <div
        className={`${styles["shipping-item-row"]} ${
        ...
        <div>
          <RegexInput
            ...
            handler={(value) => {
              updateShipmentSlice(
                shipment,
                update<ShipmentItem>(item, "qtyPerBox", value)
              );
            }}
        ...
        <div>
          <RegexInput
            ...
            handler={(value) => {
              updateShipmentSlice(
                shipment,
                update<ShipmentItem>(item, "length", value)
              );
            }}
            errorMessage={"Numbers only"}
          />
        ...
        <div>
          <RegexInput
            ...
            handler={(value) => {
              updateShipmentSlice(
                shipment,
                update<ShipmentItem>(item, "height", value)
              );
            }}
            errorMessage={"Numbers only"}
          />
        ...
        <div>
          <RegexInput
            ...
            handler={(value) => {
              updateShipmentSlice(
                shipment,
                update<ShipmentItem>(item, "width", value)
              );
            }}
            errorMessage={"Numbers only"}
          />
